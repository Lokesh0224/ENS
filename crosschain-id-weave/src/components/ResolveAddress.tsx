    ...
    try {
      if (selectedChain === 'ethereum') {
        ...
        const result: ResolvedAddress = {
          ...
          chain: 'ethereum',
          address: ethAddress,
          proofHash: ethers.id(`${ensName}-${ethAddress}`), // keccak256 hash
          timestamp: Date.now(),
          verified: true,
          metadata: {
